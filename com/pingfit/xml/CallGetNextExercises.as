package com.pingfit.xml {
	...
	public class CallGetNextExercises extends XmlCallBase {
		


		public function CallGetNextExercises() { 
			var methodParams:Array = new Array();
			var param0:MethodParam = new MethodParam("method", "getNextExercises");
