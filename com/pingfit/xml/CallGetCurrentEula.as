package com.pingfit.xml {
	...
	public class CallGetCurrentEula extends XmlCallBase {
		


		public function CallGetCurrentEula(plid:int) { 
			var methodParams:Array = new Array();
			var param0:MethodParam = new MethodParam("method", "getCurrentEula");
