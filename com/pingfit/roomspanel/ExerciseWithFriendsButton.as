package com.pingfit.roomspanel
{
	...
	public class ExerciseWithFriendsButton extends Sprite {
		...
		public function ExerciseWithFriendsButton(maxWidth:Number, maxHeight:Number):void{
			...
			mainText = TextUtil.getTextField(TextUtil.getHelveticaRounded(10, 0xE6E6E6, true), 100, "Exercise with Friends");
		...
		public function resize (maxWidth:Number, maxHeight:Number):void {
			trace("ExerciseWithFriendsButton -- RESIZE -- maxWidth="+maxWidth+" maxHeight="+maxHeight);
			this.maxWidth = maxWidth;
			this.maxHeight = maxHeight;
			bg.graphics.clear();
